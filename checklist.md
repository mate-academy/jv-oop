...
- The message should indicate what type of `core.machines.Machine` is working right now `core.machines.Truck`, `core.machines.Bulldozer` or `core.machines.Excavator`.
